...
The fundamental law of Butterfly creation is the singularity principle:
...
- **Seed (singularity)**: The minimal coordinate rule that defines an object. Never the payload. Never the full implementation. Just the generative rule.
- **Bloom**: The inverse operation that expands a seed through substrate axes into full implementation.
- **Collapse**: The forward compression that takes a full implementation and derives its minimal seed.
- **Render**: The final projection of bloomed state into visible, runnable form.

### The Governing Equation

The manifold equation `z = x * y` demonstrates this directly:
...
This cycle is the operational heartbeat of Butterfly IDE. Helix must reason in this cycle.
